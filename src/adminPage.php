...
<button type="submit" class="logout-button"  ><a href="adminlogout.php" >LOGOUT</a></button>
 ...
 <div id="app" class="container">
  <!--<card data-image="https://images.unsplash.com/photo-1479660656269-197ebb83b540?dpr=2&auto=compress,format&fit=crop&w=1199&h=798&q=80&cs=tinysrgb&crop="> -->
    ...
    <a href="newStudInfo.php">
    <card data-image="https://www.programiz.com/sites/all/themes/Ultimate/img/learn-to-code.jpg">
    <h1 slot="header">ENTER NEW STUDENT DETAILS</h1></a>
  ...
  <!-- <card data-image="https://images.unsplash.com/photo-1479659929431-4342107adfc1?dpr=2&auto=compress,format&fit=crop&w=1199&h=799&q=80&cs=tinysrgb&crop="> -->
    ...
    <a href="editStud.php">
    <card data-image="https://th.bing.com/th/id/OIP.xDr3EUIHb02xmKmbN3guLAHaHa?pid=ImgDet&rs=1">
     <h1 slot="header">EDIT STUDENT DETAILS</h1></a>
